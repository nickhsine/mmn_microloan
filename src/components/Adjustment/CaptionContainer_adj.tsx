...
export const CaptionContainer = forwardRef<gsap.core.Timeline>((_, ref) => {
  ...
  return (
    <div className="caption-container" ref={containerRef}>
      ...
      <Caption category="normal" startAt={34.2} stayFor={1}>
      米奇向第一國際申請10萬元手機貸款
      </Caption>
      <Caption category="normal" startAt={34.3} stayFor={1}>
      內扣手續費15,350元後
      </Caption>
      <Caption category="normal" startAt={34.4} stayFor={1}>
      實際核發84,470元
      </Caption>
       <Caption category="normal" startAt={34.5} stayFor={1}>
      被王道國際要求全數匯出作為服務費
      </Caption>
      <Caption category="normal" startAt={34.6} stayFor={1}>
      債務整合尚未開始，又新增一筆13萬635元債務
      </Caption>
      <Caption category="normal" startAt={35.5}>
      三個月後......
      </Caption>
