...
import { TimelineHandle, RefFromTo,  AddStartTL, AddEndTL, AddNoScrubTL, PauseTL, ResumeTL } from '../utility/TimelineHandle';
...
export const SectionMissh = forwardRef<gsap.core.Timeline>((_, ref) => {
  ...
  useGSAP(() => {
    ...
    // PauseTL(misshTL, messagesRef.current, '<6');
    // ResumeTL(misshTL, messagesRef.current, '>6');
